...
#define _CRON_PATHS_H_
		 ...
		 */
#define SPOOL_DIR	"/home/sean/cron/var/spool/cron"
...
#define CRON_HOSTNAME	".cron.hostname"
		 ...
		 */
#define	CRON_ALLOW	"/home/sean/cron/etc/cron.allow"
#define	CRON_DENY	"/home/sean/cron/etc/cron.deny"

		/* 4.3BSD-style crontab f.e. /etc/crontab */
#define SYSCRONTAB	"/home/sean/cron/etc/crontab"

		/* system crontab dir f.e. /etc/cron.d/ */
#define SYS_CROND_DIR	"/home/sean/cron/etc/cron.d"

#define SYSCONFDIR	"/home/sean/cron/etc"
