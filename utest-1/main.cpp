...
TEST(salt, parse_json_job_new) {
  ...
  const char *json_data = {
      ...
      "\"Server178\", \"Server179\"]}}"};
  EXPECT_EQ(0, parse_salt_job_new(jobnew, json_data));
  ...
  EXPECT_EQ(0, parse_salt_job_new(jobnew, json_data_2));
...
TEST(salt, parse_json_job_ret) {
  ...
  EXPECT_EQ(0, parse_salt_job_ret(ret, json_data));
  ...
  EXPECT_EQ(0, parse_salt_job_ret(ret, json_data_2));
